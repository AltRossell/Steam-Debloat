...
$Debug = "off"
$Mode = "NormalBoth2022-2025"

$script:config = @{
    Title               = "Steam Downgrade - Both Versions (2022 & 2025)"
...
function Start-SteamDowngrade {
    ...
    try {
        ...
        Write-DebugLog "Both Steam versions have been installed and configured." -Level Success
...
Write-DebugLog "Mode: NormalBoth2022-2025 (Experimental - Install both versions)" -Level Info
Write-Host ""
